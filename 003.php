...
$conteudor2 = '<a rel="category tag" href="https://www.qwant.com/?q='.htmlentities($link, ENT_QUOTES, "utf-8").'+site:' . htmlentities($EnderecoSite, ENT_QUOTES, "utf-8") . '" title="tag search" target="_blank">'.htmlentities($link, ENT_QUOTES, "utf-8").'</a>';
}
echo html_entity_decode($conteudor2, ENT_HTML5, "utf-8");
$conteudor3 = '
</span>
</small></p>
</footer>
